 ...
 * @author INSTRUCTOR
 */
public class ListadoVendedores extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        JsonObject jsonObject = JsonParser.parseString(consumoApi.consumoGETV1("http://localhost/APIenPHP/Usuarios/Obtener_Vendedores.php", data)).getAsJsonObject();

        JsonArray jsonArray = jsonObject.getAsJsonArray("registros");

        for (int i = jsonArray.size() - 1; i >= 0; i--) {
            JsonObject registroJson = jsonArray.get(i).getAsJsonObject();
            String identificacion = registroJson.get("identificacion").getAsString();
            String nombreUsuario = registroJson.get("nombreusuario").getAsString();
            String correoElectronico = registroJson.get("correoelectronico").getAsString();
            String estado = registroJson.get("estado").getAsString();

            Object[] temp = {identificacion, nombreUsuario, correoElectronico, estado};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IDENTIFICAION", "NOMBRE", "CORREO", "ESTADO"
            }
        ));
        ...
        btnEditar.setText("EDITAR O REGISTRAR");
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (container != null) {
            container.removeAll();
            editarVendedor.setSize(container.getSize());
            editarVendedor.setLocation(0, 0);
            // Agregar el panel de ingreso de vehículos al contenedor
            container.add(editarVendedor);
            container.repaint();
